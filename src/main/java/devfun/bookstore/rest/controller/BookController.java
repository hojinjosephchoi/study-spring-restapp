...
//    }
    ...
    public Resources<BookResource> getBooks(Model model) {
        ...
        Resources<BookResource> wrapped = new Resources<BookResource>(resources, ControllerLinkBuilder.linkTo(BookController.class).withSelfRel());
        return wrapped;
    }
